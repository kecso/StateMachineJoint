"""
This script is called by the plugin-wrapper, ExportToPy.js, which passes down the
...
from ExportToPy import ExportToPy
...
plugin = ExportToPy(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
