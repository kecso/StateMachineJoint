"""
This script is called by the plugin-wrapper, ImportFromPy.js, which passes down the
...
from ImportFromPy import ImportFromPy
...
plugin = ImportFromPy(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
