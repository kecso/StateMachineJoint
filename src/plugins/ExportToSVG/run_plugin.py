"""
This script is called by the plugin-wrapper, ExportToSVG.js, which passes down the
...
from ExportToSVG import ExportToSVG
...
plugin = ExportToSVG(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
